 ...
 */
[_QWERTY] = {
  {KC_QUOT        , KC_COMM , KC_DOT  , KC_P    , KC_Y           , KC_TAB    , KC_NO         , KC_F          , KC_G    , KC_C    , KC_R    , KC_L         } ,
  {KC_A           , KC_O    , KC_E    , KC_U    , KC_I           , KC_GRV    , KC_MINS       , KC_D          , KC_H    , KC_T    , KC_N    , KC_S         } ,
  {SFT_T(KC_SCLN) , KC_Q    , KC_J    , KC_K    , KC_X           , KC_LALT   , KC_RALT       , KC_B          , KC_M    , KC_W    , KC_V    , SFT_T(KC_Z)  } ,
  {KC_ESC         , KC_LCTL , KC_DOWN , KC_UP   , GUI_T(KC_BSPC) , TD(TD_LS) , CTL_T(KC_ENT) , GUI_T(KC_SPC) , KC_LEFT , KC_RGHT , KC_BSLS , KC_NO        }
                                                                                                                                                          } ,
[_SYMBOL] = {
